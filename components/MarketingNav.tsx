      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0 24px', height: 64, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
            <Image src="/barguard_icon.png" alt="" width={56} height={56} style={{ height: 56, width: 'auto', display: 'block' }} priority />
          ...
          <div className="mnav-links">
            ...
            <Link href="/how-it-works" className="mnav-text-link" data-gtm-event="nav_click" data-gtm-label="nav_screenshots" style={{ fontSize: 14, color: '#94a3b8', textDecoration: 'none', padding: '8px 14px', borderRadius: 8 }}>How It Works</Link>
            ...
            <Link href="/blog" className="mnav-text-link" data-gtm-event="nav_click" data-gtm-label="nav_blog" style={{ fontSize: 14, color: '#94a3b8', textDecoration: 'none', padding: '8px 14px', borderRadius: 8 }}>Blog</Link>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <Image src="/barguard_icon.png" alt="" width={52} height={52} style={{ height: 52, width: 'auto' }} />
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              ...
              <Link href="/how-it-works" onClick={() => setMenuOpen(false)} data-gtm-event="nav_click" data-gtm-label="nav_mobile_screenshots" style={{ fontSize: 16, color: '#94a3b8', textDecoration: 'none', padding: '12px 16px', borderRadius: 10, display: 'block' }}>
                How It Works
              </Link>
              ...
              <Link href="/blog" onClick={() => setMenuOpen(false)} data-gtm-event="nav_click" data-gtm-label="nav_mobile_blog" style={{ fontSize: 16, color: '#94a3b8', textDecoration: 'none', padding: '12px 16px', borderRadius: 10, display: 'block' }}>
                Blog
              </Link>
