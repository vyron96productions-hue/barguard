...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-5 max-w-[1400px]">
      ...
      {/* Command Bar */}
      <div className="flex flex-col gap-3 px-4 sm:px-5 py-4 rounded-2xl bg-slate-900/60 border border-slate-800/60">
        {/* Date range row */}
        <div className="grid grid-cols-2 sm:flex sm:flex-row sm:flex-wrap sm:items-center gap-2 sm:gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <button
            ...
            className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 sm:py-2 bg-amber-500 hover:bg-amber-400 active:bg-amber-300 text-slate-900 font-semibold rounded-xl sm:rounded-lg text-sm transition-all duration-150 shadow-[0_0_20px_rgba(245,158,11,0.25)]"
          >
          ...
          <button
            ...
            className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 sm:py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-slate-100 font-medium rounded-xl sm:rounded-lg text-sm transition-colors disabled:opacity-40 disabled:cursor-not-allowed border border-slate-700/60"
          >
          ...
          <button
            ...
            disabled={clearing}
            className="p-2.5 sm:p-2 text-slate-600 hover:text-red-400 font-medium rounded-xl sm:rounded-lg text-sm transition-colors disabled:opacity-40 border border-transparent hover:border-red-500/20 hover:bg-red-500/5"
            title="Clear results"
          >
      ...
      {hasData ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 sm:py-24 rounded-2xl bg-slate-900/40 border border-slate-800/40 border-dashed">
          ...
          <p className="text-slate-600 text-xs mt-1 text-center px-4">
            {loading ? 'Loading…' : 'Set a date range and run calculations'}
          </p>
        </div>
      )}
