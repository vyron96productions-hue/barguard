  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#020817', padding: '64px 24px' }}>
      <div style={{ maxWidth: 640, margin: '0 auto' }}>
        ...
        {/* About section — provides context and word count */}
        <div style={{ marginTop: 40, padding: '24px 0', borderTop: '1px solid #1e293b' }}>
          <h2 style={{ fontSize: 16, fontWeight: 600, color: '#f8fafc', marginBottom: 12 }}>About BarGuard Uptime</h2>
          <p style={{ fontSize: 14, color: '#64748b', lineHeight: 1.7, marginBottom: 12 }}>
            BarGuard is hosted on enterprise-grade infrastructure with redundant systems across all critical components — application servers, database, payment processing, AI features, and email delivery. We monitor each service continuously and publish real-time status here.
          </p>
          <p style={{ fontSize: 14, color: '#64748b', lineHeight: 1.7, marginBottom: 12 }}>
            Our target uptime is 99.9% across all services. Planned maintenance windows are announced at least 24 hours in advance. In the event of an unplanned disruption, we update this page within 15 minutes of detection and send notifications to affected customers.
          </p>
          <p style={{ fontSize: 14, color: '#64748b', lineHeight: 1.7 }}>
            Experiencing an issue not reflected here? Contact us at{' '}
            <a href="mailto:support@barguard.app" style={{ color: '#f59e0b', textDecoration: 'none' }}>
              support@barguard.app
            </a>
            {' '}— our support team responds within one business day, with priority handling for active outages.
          </p>
        </div>
      </div>
