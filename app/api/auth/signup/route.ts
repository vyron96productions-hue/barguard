      ...
      html: `
        <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:24px;background:#0f172a;color:#e2e8f0;border-radius:12px">
          ...
          <table style="width:100%;border-collapse:collapse">
            <tr><td style="color:#64748b;padding:6px 0;width:120px">Bar name</td><td style="color:#e2e8f0;padding:6px 0"><strong>${bar_name}</strong></td></tr>
