...
export async function POST(req: NextRequest) {
  ...
  // ── 1. Fetch sales aggregated by menu_item ───────────────────────────────
  let query = supabase
  ...
  // ── 3. Fetch recipes + costs in parallel ─────────────────────────────────
  ...
  // recipes grouped by menu_item_id
